            ...
            with left_column:
                ...
                with empty_state:
                    ...
                    suggestions = [
                        ...
                        ("✦36氪", "36氪的5条热门内容。", 160, -100),
                        ("✦电影", "豆瓣上的5个热门电影。", -180, -45),
                        ("✦新浪", "新浪财经的前5个滚动新闻。", 150, -45),
                        ("✦py", "Python的生命周期支持情况。", -150, 0),
                        (
                            "✦车票",
                        ...
                        # ring2
                        ("✦漏洞", "查查漏洞CVE-2026-2827。", -20, -275),
                        ("✦微博", "微博上的5条热门内容。", -160, -250),
                        ("✦知乎", "知乎上的5条热门内容。", 130, -250),
                        ("✦词典", "在dictionary上查询token。", -250, -195),
                        ("✦酒店", "携程上后天入住成都的酒店。", 220, -195),
                        ("✦u2b", "youtube上关于'Pump It Up'的5条内容。", -310, -100),
                        ("✦码云", "看看gitee推荐的前5个开源项目", 280, -100),
                        ("✦读书", "微信读书搜索红楼梦。", -300, -10),
                        ("✦搜索", "用雅虎搜索若苗瞬。", 270, -10),
                        ("✦npm", "npm里@jackwener/opencli的下载情况", -230, 65),
                        ("✦股票", "看看东方财富热股榜。", 200, 65),
                        # ring3
                        ("✦pixiv", "pixiv的每月插画排行。", -120, 120),
                        (
                            "✦活动",
                            "从明天开始，成都举办的 OPC 主题的线下/线上活动。",
                            90,
                            120,
                        ),
                    ]
                    ...
                    ui.label("通过OpenCLI查询多方面内容").style("""
